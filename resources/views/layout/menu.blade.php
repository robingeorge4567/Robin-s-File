    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        <li><a class="dropdown-item" href="{{ route('profile','1') }}">Profile</a></li>
            ...
            <li class="{{ request()->is('home') ? 'active':'' }}">
                <a href="{{ route('home') }}"><i class="fa fa-th-large"></i> <span class="nav-label">Dashborad</span></a>
            </li>
        <?php 
    $segment1 = Request::segment(1);
    $pages = array('projects', 'add_project','edit_project')
        ?>    
            <li class="@if(in_array($segment1, $pages)) active @endif">
                <a href="{{ route('projects') }}"><i class="fa fa-diamond"></i> <span class="nav-label">Projects</span></a>
            </li>


            <?php 
            $segment1 = Request::segment(1);
            $pages = array('haccounts','add_haccounts')
                ?>    
                    <li class="@if(in_array($segment1, $pages)) active @endif">
                        <a href="{{ route('haccounts') }}"><i class="fa fa-diamond"></i> <span class="nav-label">Accounts</span></a>
                    </li>
            {{-- <li>
