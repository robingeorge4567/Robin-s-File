...
<div class="footer">
   <!-- <div class="float-right">
    ...
    <div>
        <strong>Copyright</strong> PixelFLoat &copy; <?php echo date('Y'); ?>
    </div>
</div>
</div>
...
<script src="{{ asset('storage/js/plugins/flot/jquery.flot.symbol.js') }}"></script>
<script src="{{ asset('storage/js/plugins/flot/jquery.flot.time.js') }}"></script>
...
<!-- EayPIE -->
<script src="{{ asset('storage/js/plugins/easypiechart/jquery.easypiechart.js') }}"></script>

<!-- Sparkline -->
<script src="{{ asset('storage/js/plugins/sparkline/jquery.sparkline.min.js') }}"></script>

<!-- Sparkline demo data  -->
<script src="{{ asset('storage/js/demo/sparkline-demo.js') }}"></script>
...
<script>
    ...
    sum();
    $("#amnt, #ramnt").on("focusout", function() {
        var num1 = document.getElementById('amnt').value;
...
function sum() {
            var num1 = document.getElementById('amnt').value;
            var num2 = document.getElementById('ramnt').value;
			var result1 = parseInt(num1) - parseInt(num2);
            var first=parseInt(num1);
            var second=parseInt(num2);
            
            if( first < second ) {
                alert('the amount should be greater than amount received');
                //document.getElementById('ramnt').value = "";
                document.getElementById('bamnt').value = "";
                return false;
           ...
           if(num1===''||num2===''){
            ...
            if (!isNaN(result1)) {
				...
				document.getElementById('bamnt').value = result1;
            }
        }  
        }
</script>
